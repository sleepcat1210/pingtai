	...
	<form action="" method="post" class="form form-horizontal" id="form-menu-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				...
				<option value="0">顶级</option>
					...
					<option value="{{$v->menu_id}}" 
					@if($v->menu_id ==$wxmenu->menu_id)
					selected="selected"
					@endif
					>{{$v->menu_name}}</option>
                                    @endforeach
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$wxmenu->menu_name}}" name="menu_name">
			</div>
		</div>  
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				...
				<option value="1"
				@if($wxmenu->menu_event_type ==1)
				checked="checked"
				@endif
				>普通url</option>                  
				<option value="2"
				@if($wxmenu->menu_event_type ==2)
				checked="checked"
				@endif
				>图文素材</option>                  
				<option value="3"
				@if($wxmenu->menu_event_type ==3)
				checked="checked"
				@endif
				>功能</option>                  
				</select>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$wxmenu->menu_content}}"  name="menu_content">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>排序：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="sort" value="{{$wxmenu->sort}}">
			</div>
		</div>		
