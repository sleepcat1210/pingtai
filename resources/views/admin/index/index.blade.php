...
<aside class="Hui-aside">
	...
	@foreach($per_list as $k=>$v)
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">{!!$v['act_icon']!!}</i>{{$v['act_name']}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
				@foreach($v['son'] as $k1=>$v1)
					<li><a data-href="{{url($v1['act_r'])}}" data-title="{{$v1['act_name']}}" href="javascript:void(0)">{{$v1['act_name']}}</a></li>
			    @endforeach
				</ul>
		    </dd>
	    </dl>
